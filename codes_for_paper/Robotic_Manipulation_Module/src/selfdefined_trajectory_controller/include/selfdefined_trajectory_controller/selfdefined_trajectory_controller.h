...
namespace selfdefined_controllers
{
  ...
  protected:
    ...
    // Processing actionsgoalofCancel request
    void cancelCB(GoalHandle gh);
    // Suspend the current activity objective（ActiveGoal）
    void preemptActiveGoal();
    // Query trajectory statusofservice request
